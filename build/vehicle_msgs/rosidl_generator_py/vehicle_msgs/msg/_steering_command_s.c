...
bool vehicle_msgs__msg__steering_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_msgs.msg._steering_command.SteeringCommand", full_classname_dest, 50) == 0);
  }
  vehicle_msgs__msg__SteeringCommand * ros_message = _ros_message;
  {  // steering_angle
...
PyObject * vehicle_msgs__msg__steering_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_msgs.msg._steering_command");
